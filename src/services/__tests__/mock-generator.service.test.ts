...
describe('Mock Generator Service', () => {
    ...
    describe('generateMockData', () => {
        ...
        it('should generate realistic currency by property name', () => {
            const schema: SchemaObject = {
                type: 'string' as const,
            };

            const result = generateMockData(schema, 'currency') as string;
            expect(result).toMatch(/^[A-Z]{3}$/);
        });

        it('should generate realistic price by property name', () => {
            const schema: SchemaObject = {
                type: 'number' as const,
            };

            const result = generateMockData(schema, 'productPrice') as number;
        ...
        it('should generate realistic amount by property name', () => {
            const schema: SchemaObject = {
                type: 'number' as const,
            };

            const result = generateMockData(schema, 'totalAmount') as number;
